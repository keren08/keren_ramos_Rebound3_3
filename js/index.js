...
form.addEventListener("click", (e) => {
  if (input.value != "") {
    ...
    if (e.target.id == "feliz") {
      cambiar(
        "rgb(253,234,220)",
        "linear-gradient(180deg, rgba(253,234,220,1) 2%, rgba(249,187,141,1) 50%, rgba(245,164,100,1) 100%, rgba(243,147,71,1) 100%)",
        "#F3E600",
        "#F5AB05"
      );
    ...
    if (e.target.id == "tranquila") {
      cambiar(
        "rgb(240,247,244)",
        "linear-gradient(180deg, rgba(240,247,244,1) 2%, rgba(205,230,219,1) 50%, rgba(177,217,200,1) 100%, rgba(154,208,185,1) 100%)",
        "#6BC2BD",
        "white"
      );
    ...
    if (e.target.id == "triste") {
      cambiar(
        "rgb(224,223,228)",
        "linear-gradient(175deg, rgba(215,219,219,1) 1%, rgba(126,130,131,1) 50%, rgba(1,1,19,1) 100%)",
        "#27295A",
        "white"
      );
    ...
    if (e.target.id == "enojada") {
      cambiar(
        "rgb(250,224,225)",
        "linear-gradient(180deg, rgba(250,224,225,1) 2%, rgba(233,152,145,1) 50%, rgba(219,94,88,1) 100%, rgba(205,39,34,1) 100%)",
        "#EE7579",
        "white"
      );
